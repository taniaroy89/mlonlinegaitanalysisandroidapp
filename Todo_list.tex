...
\begin{enumerate}
	\item finire capitolo risultati e conclusioni
	\item inserire dati calcolo cadenza
	\item inserire correzioni Dada
	\item inserire correzioni Charlie
	\item rivedere parte thread
	\item scrivere sull'unità di controllo
