...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\par\textsc{Scrittura di uno UT}: lo UT istanza l'oggetto dalla classe da verificare, ed invoca il metodo con valori per i quali è noto il comportamento (teorico) del metodo da verificare.\\
...
\begin{itemize}
	...
	\item Richiesta all'adattatore \textit{Bluetooth} (\textit{Bluetooth Adapter}) della lista di dispositivi abbinati (paired)\footnote{Due dispositivi sono detti paired quando questi sono l'uno a conoscenza dell'esistenza dell'altro.};
