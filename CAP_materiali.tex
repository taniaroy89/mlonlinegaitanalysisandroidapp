...
Le prove sono state compiute su un tapis roulant su un intervallo di velocità [3-7]Km/h per il cammino e [8-12]Km/h per la corsa. Ciascuna sessione è stata della durata di 2 minuti. La prima sessione alla velocità di 3Km/h e con un incremento di 1Km/h in ciascuna sessione successiva.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|c|c|}
		\hline		
			...
			\hline
			\textbf{Strumenti} & \multicolumn{2}{c|}{IMU, Vicon, tapis roulant}\\
			\hline
