...
%--------------------------------------------------------------
\documentclass[twoside,openright,titlepage,fleqn,headinclude,11pt,a4paper,BCOR=15mm,footinclude]{scrbook}
...
\newcommand{\myVersion}{\small \textcolor{red}{} \xspace} %last committed svn version.build-----Revisione 24.0
\newcommand{\myShortVersion}{\small \textcolor{red}{} \xspace}%v24.0
...
\addtocontents{toc}{\protect\mbox{}\protect\hrulefill\par}
\part{Lavoro svolto}
\include{CAP_modellazione}
\include{CAP_AndroidApp}
\include{CAP_valutazione}
