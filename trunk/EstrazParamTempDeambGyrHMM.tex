...
\newcommand{\myVersion}{\small \textcolor{red}{Revisione 20.0} \xspace} %last committed svn version.build
\newcommand{\myShortVersion}{\small \textcolor{red}{v20.0} \xspace}
...
\end{center}\include{APPENDICE_hmm}
