...
\begin{itemize}
	...
	\item un vettore di probabilità a priori $\pi$ che determina $\forall i=1,...,N$ la probabilità che il processo sia nello stato $S_i$ a tempo $t_1=0$, ovvero $\wp(q_0 = \pi_i)$, dove $q_k$ è lo stato del processo markoviano a tempo $k$.
...
Il problema della valutazione (Evaluation) consiste nel calcolare la probabilità che una certa sequenza di osservazioni sia stata prodotta da un dato modello.\\
