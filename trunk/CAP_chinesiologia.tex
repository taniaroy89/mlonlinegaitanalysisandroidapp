...
La branca della Meccanica Classica che viene utilizzata dalla Biomeccanica è la Cinematica \cite{Encyclopedia_Britannica_online}
...
\section{Deambulazione}
La deambulazione (\textit{Gait}) è la sequenza di movimenti degli arti inferiori che un animale compie su una superficie solida durante la locomozione \cite{Herbrand_gait}.
