...
della Deambulazione: Sviluppo e Valutazione di un applicativo per Smartphone\xspace}
...
%fr Machine Learning Méthodes d'analyse temps réel la marche: Développement et validation sur un Smartphone
%de Methoden des maschinellen Lernens für Real-Time-Ganganalyse: Entwicklung und Validierung auf einem Smartphone
%es Machine Learning métodos de análisis de la marcha real de tiempo: Desarrollo y validación en un Smartphone
...
\newcommand{\myFaculty}{
	Facoltà di Scienze Matematiche, Fisiche e Naturali\xspace}
...
\newcommand{\myVersion}{\small \textcolor{red}{Revisione 4.15} \xspace} %last committed svn version.build
\newcommand{\myShortVersion}{\small \textcolor{red}{v4.15} \xspace}
...
\include{CAP_intro} % use \myChapter command instead of \chapter
\include{CAP_chinesiologia}
\include{CAP_statoDellArte}
...
\include{CAP_materiali}
\include{CAP_AndroidApp}
\include{CAP_validazione}
\include{CAP_risultati}
%--------------------------------------------------------------
% Backmatter
%--------------------------------------------------------------
...
\include{APPENDICE_hmm}
\include{APPENDICE_realtime}
\include{APPENDICE_meccanica}
\include{APPENDICE_sensori}
\include{APPENDICE_android}
