...
Un'altra applicazione è quella implementata dalla Apple, nei suoi portatili per la protezione del disco rigido: se il portatile dovesse cadere mentre acceso, l'accelerometro capta la caduta libera ed il sistema operativo si auto termina immediatamente in modo che la testina non sia sul disco. 
...
Il tipo di giroscopio che usiamo in questo lavoro è il cosiddetto giroscopio piezoelettrico, o MEMS (Micro Electro Mechanical System) o a vibrazione. Si basa sul principio di Coriolis: un oggetto che vibra, continua a vibrare sullo stesso piano se la struttura che lo sostiene è in rotazione. 
...
\hline
\hline
\multicolumn{3}{|l|}{\textbf{Connettività}}\\
